...
export const translations = {
    en: {
        ...
        detail: {
            ...
            abilityTags: "Abstract Ability Tags",
            abilityTagsPlaceholder: "Enter or select ability tags, up to 4",
            abilityTagsHint: "Ability tags summarize weak skills and do not affect knowledge tags",
            noAbilityTags: "No ability tags yet",
            close: "Close",
            clickOutside: "Click outside to close",
        },
        abilityTags: {
            title: "Abstract Ability Tags",
            subtitle: "Batch analyze wrong answers and summarize weak skills",
            batchTitle: "Batch Analysis",
            mode: "Scope",
            onlyUnclassified: "Only unclassified items",
        ...
        printPreview: {
            ...
            showTags: "Show Tags",
            showAbilityTags: "Show Ability Tags",
    ...
    zh: {
        ...
        detail: {
            ...
            abilityTags: "抽象能力标签",
            abilityTagsPlaceholder: "输入或选择能力标签，最多 4 个",
            abilityTagsHint: "💡 能力标签用于归纳薄弱点，不会影响知识点标签",
            noAbilityTags: "暂无能力标签",
            close: "✕ 关闭",
            clickOutside: "点击图片外部区域关闭",
        },
        abilityTags: {
            title: "抽象能力标签",
            subtitle: "批量分析错题，归纳能力薄弱点",
            batchTitle: "批量分析",
            mode: "分析范围",
            onlyUnclassified: "仅分析未分类题目",
            pendingCount: "待分析",
            availableTags: "可用标签",
            running: "分析中...",
            run: "开始分析",
